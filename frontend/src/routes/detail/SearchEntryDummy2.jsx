      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center gap-2">
          ...
          <div className="flex gap-2 items-center">
            Cari Berdasarkan:
            <button className="btn btn-neutral btn-sm">Perusahaan</button>
            <button className="btn btn-neutral btn-sm">Siswa</button>
...
export default SearchEntryDummy2;
